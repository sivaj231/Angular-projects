...
@Component({
  selector: 'app-upload-nc-mobile',
  templateUrl: './upload-nc-mobile.component.html',
  styleUrls: ['./upload-nc-mobile.component.css']
})
export class UploadNcMobileComponent implements OnInit {
  ...
  onSubmit() {
    this.formData.append('uploadType', 'NOT_CONTACTABLE');
    this.submitted = true;
